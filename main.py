...
class MyGrid(BoxLayout):
    def __init__(self, **kwargs):
        ...
        textinput = TextInput(text='Искать',
        ...
        for row in db:
            submit = Button(text=row[2], font_size=20, size_hint=(0.5, None))
            submit.id = row[0]
            submit.b = False
    ...
    def on_enter(self, t):
        ...
        back = Button(text="Back", font_size=20, size_hint=(0.5, None))
        back.b = True
    ...
    def pressed(self, instance):
        ...
        if len(db) > 0 and db[0][3] != None:
            ...
            for row in db:
                submit = Button(
                    text=row[2], font_size=20, size_hint=(0.5, None))
                submit.id = row[0]
                submit.b = False
                submit.bind(on_press=self.pressed)
                self.contend_scroll_view.add_widget(submit)
